...
import { View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Animated, Easing, ImageBackground } from 'react-native';
    ...
    <ImageBackground source={BG} style={styles.bg} resizeMode="cover">
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.sub}>{isDraw ? 'A close one!' : isWin ? 'Well played!' : 'Keep practicing!'}</Text>

          <View style={styles.cards}>
            <ScoreCard name={myName} color={myColor} score={me.score} words={me.words} mmrDelta={me.mmrDelta} newMmr={me.newMmr} highlight={isWin ? '#22c55e' : null} />
            <View style={styles.vsDivider}>
              <Text style={styles.vsDividerText}>VS</Text>
            </View>
            <ScoreCard name={oppName} color={oppColor} score={opp.score} words={opp.words} mmrDelta={opp.mmrDelta} newMmr={opp.newMmr} highlight={isLoss ? '#ef4444' : null} />
          </View>
...
function ScoreCard({ name, color, score, words, mmrDelta, newMmr, highlight }) {
  return (
...
const styles = StyleSheet.create({
  ...
  sub: {
    color: '#fde68a', fontSize: 15, marginTop: 12, marginBottom: 22, fontWeight: '800',
