...
import TierDownScreen from './src/screens/TierDownScreen';
...
import PakistanQuestScreen from './src/screens/PakistanQuestScreen';
...
function Navigator() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="TierDown" component={TierDownScreen} options={{ headerShown: false, cardStyleInterpolator: CardStyleInterpolators.forFadeFromBottomAndroid, gestureEnabled: false }} />
      ...
      <Stack.Screen name="Practice" component={PracticeScreen} options={{ headerShown: false, cardStyleInterpolator: CardStyleInterpolators.forScaleFromCenterAndroid, gestureEnabled: false }} />
      <Stack.Screen name="PracticeResult" component={PracticeResultScreen} options={{ headerShown: false, cardStyleInterpolator: CardStyleInterpolators.forFadeFromBottomAndroid }} />
      <Stack.Screen name="PakistanQuest" component={PakistanQuestScreen} options={{ headerShown: false, cardStyleInterpolator: CardStyleInterpolators.forScaleFromCenterAndroid, gestureEnabled: false }} />
    </Stack.Navigator>
  );
}
